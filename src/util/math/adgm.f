      SUBROUTINE sp_bess_i( x, n, val )
      IMPLICIT NONE
      DOUBLE PRECISION X, BI(2001), BK(2001), VAL
      INTEGER N, NMAX, NUEVO
      NMAX = N + 1
...
c$$$       DIMENSION bi(2001),bk(2001) 
c$$$
c$$$       x = 2.5d0
c$$$       Nmax = 3
c$$$       CALL bessimse(x,Nmax,bi,bk,nuevo)
c$$$       DO 101 I = 1, nuevo
c$$$          PRINT*, I, bi(I), bk(I)
c$$$ 101   CONTINUE
c$$$
